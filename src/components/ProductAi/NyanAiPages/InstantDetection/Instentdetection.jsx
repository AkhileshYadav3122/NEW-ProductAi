          ...
          <div id="text">
            <div className="main-wrapper">
              <div className="col-12 col-md-6 col-sm-6 ">
                <h6 className="px-3">
                  <span style={{ fontWeight: "500" }}>Instent Detection</span>
                    ...
                    <div className="file-upload-container">
                      ...
                      >
                        ...
                        >
                          ...
                          />
                          <h4>Instent Detection</h4>
                          <p>
                            (.mp4,.wav,.mp3,.mpg,.wmv,.mov and .avi supported)
                          </p>
                          <span>
                            <FontAwesomeIcon
...
export default Instentdetection;
