          ...
          <div id="text">
            <div className="main-wrapper">
              <div className="col-6 col-md-6 col-sm-6 ">
                <h6 className="px-3">
                  <span style={{ fontWeight: "500" }}>Find Diffrence</span>
              ...
              <div className="row icon-container mt-1 p-2">
                <div className="col-md-12 text-md-end d-flex flex-wrap">
