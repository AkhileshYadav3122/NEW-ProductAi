! function(e) {
    ...
    e.Navbar = {
                ...
                if (o) {
                    ...
                    a.onreadystatechange = function() {
                        if (4 == this.readyState && 200 == this.status) {
                            ...
                            n.classList.add("form-result-show"), n.style.display = "block", e ? (n.innerHTML = e.message, "success" == e.result ? (n.classList.add("form-result-success"), n.classList.remove("form-result-error"), setTimeout((function() {
                                n.style.display = "none"
                            }), 8e3)) : (n.classList.add("form-result-error"), n.classList.remove("form-result-success"))) : (n.classList.remove("form-result-success"), n.classList.add("form-result-error"), n.innerHTML = "error")
                        }
        ...
        e.Navbar.init(), e.Addons.swiperCarousel(".swiper-init"), e.Addons.typed(".type-init"), e.Custom.submitForm(".form-submit-init"), e.Custom.priceToggle(".pricing-toggle"), e.Custom.showHidePassword(".password-toggle"), e.Custom.darkmode(".dark-mode-toggle"), e.CurrentLink("." + t.classes.link, t.classes.item, t.classes.sub, t.classes.main, [t.classes.active, t.classes.current], !0)
    }, e.BS.init = function() {
